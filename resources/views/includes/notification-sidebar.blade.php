...
<div class="page-aside-left">
    <div class="email-menu-list mt-3">
        <a href="{{ route('affiliate.notification.list') }}" class="text-danger fw-bold"><i
        ...
        <a href="{{ route('affiliate.notification.unread') }}"><i class="dripicons-document me-2"></i>{{ __('Unread') }}
            <span
