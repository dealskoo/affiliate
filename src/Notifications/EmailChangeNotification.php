...
class EmailChangeNotification extends Notification
{
    ...
    {
        Session::put('affiliate_email_change_verify', $notifiable->routes['mail']);
        ...
        return (new MailMessage)
            ...
            ->line(__('This verify email link will expire in :count minutes.', ['count' => config('auth.passwords.affiliates.expire')]))
